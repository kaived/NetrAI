      ...
      <div className="max-w-[1760px] mx-auto px-3 sm:px-6 lg:px-10">
        <div className="flex min-h-[64px] items-center justify-between gap-2 py-2 sm:min-h-[80px] sm:py-2.5 sm:gap-5">
          <div className="flex min-w-0 items-center justify-start">
            <div className="relative h-[48px] w-[132px] overflow-hidden sm:h-[58px] sm:w-[225px] lg:h-[66px] lg:w-[255px]">
              <img
                src={netrAiLogo}
                alt="NetrAI Logo"
                className="absolute inset-0 h-full w-full origin-left -translate-x-[24%] translate-y-[8%] scale-[1.32] object-cover object-left select-none drop-shadow-sm sm:-translate-x-[34%]"
              />
            </div>
          </div>
